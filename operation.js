var hOp = InitOperation("Operation name", "", 0);
	...
	AddUserModToOperation(hOp,"_List_Var","List^item1^item2^","Tab1^Divider1",0, "");
	AddUserModToOperation(hOp,"_Check_Var","Checkbox","Tab1^Divider2",0, "");
	AddUserModToOperation(hOp,"_INT_Var","Integer","Tab1^Divider2",0, "");
	...
	AddUserModToOperation(hOp,"_Radio_Var","Radio button^item1^item2^","Tab1^Divider2",0, "");
